...
publicRoutes.use('/public/:tenantSlug/produtos', publicProdutoRoutes)
publicRoutes.use('/public/:tenantSlug/landing-page', publicLandingPageRoutes)
...
publicRoutes.use('/public/landing-page', publicLandingPageRoutes)
publicRoutes.get('/public/identidade-visual', publicIdentidadeVisualHandler)
publicRoutes.use('/public/product-lists', publicProductListRoutes)
publicRoutes.use('/public/brand', publicBrandRoutes)

// 3. Módulos Exclusivos do Cardápio
...
routes.use('/landing-pages', landingPagesRouter)
